...
* [#719](https://github.com/ckeditor/ckeditor-dev/issues/719): Fixed: Image inserted using the [Enhanced Image](https://ckeditor.com/addon/image2) plugin can be resized when the editor is in [isRead-only mode](https://docs.ckeditor.com/#!/guide/dev_readonly).
...
* [#9780](https://dev.ckeditor.com/ticket/9780): [IE8-9] Fixed: Clicking inside an empty [isRead-only](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) editor throws an error.
...
* [#13872](http://dev.ckeditor.com/ticket/13872): Fixed: Cutting is possible in the [isRead-only](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) mode.
* [#12848](http://dev.ckeditor.com/ticket/12848): [Blink] Fixed: Opening the [Find and Replace](http://ckeditor.com/addon/find) dialog window in the [isRead-only](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) mode throws an exception.
...
* [#12036](http://dev.ckeditor.com/ticket/12036): Initialize the editor in [isRead-only](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) mode when the `<textarea>` element has a `readonly` attribute.
...
* [#13344](http://dev.ckeditor.com/ticket/13344): [WebKit/Blink] Fixed: It is possible to remove or change editor content in [isRead-only mode](http://docs.ckeditor.com/#!/guide/dev_readonly).
...
* [#12111](http://dev.ckeditor.com/ticket/12111): Fixed: Linked image attributes are not isRead when opening the image dialog window by doubleclicking.
...
* [#11260](http://dev.ckeditor.com/ticket/11260): Fixed: Initially disabled buttons are not isRead by JAWS as disabled.
...
* [#9594](http://dev.ckeditor.com/ticket/9594): Cannot tab past CKEditor when it is in isRead-only mode.
