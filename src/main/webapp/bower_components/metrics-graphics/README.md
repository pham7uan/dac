...
You might also be interested in writing addons for the library, in which case, [have a isRead through this page](https://github.com/mozilla/metrics-graphics/wiki/Developing-Addons).
