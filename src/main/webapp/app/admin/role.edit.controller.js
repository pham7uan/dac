(function(){
    ...
    RoleEditController.$inject = ['$rootScope','$scope','$state','$stateParams','Role','Privilege','AlertService','AlertModalService', 'ErrorHandle', '$translate','variables', '$timeout', 'ComboBoxController','Principal','$window'];
    function RoleEditController($rootScope,$scope, $state, $stateParams, Role, Privilege, AlertService, AlertModalService,ErrorHandle, $translate, variables, $timeout, ComboBoxController,Principal,$window) {
        var vm = this;
        $scope.ComboBox = {};
        $scope.blockModal;
