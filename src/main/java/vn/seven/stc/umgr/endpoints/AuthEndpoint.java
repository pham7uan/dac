...
import vn.seven.stc.umgr.endpoints.vm.LoginVM;
import vn.seven.stc.umgr.services.AuthService;
...
public class AuthEndpoint {
    ...
    public ResponseEntity<JWTToken> token(@RequestBody LoginVM loginVM) {
        String token = this.authService.token(loginVM.getAccount(),loginVM.getPassword(),loginVM.getRememberMe());
