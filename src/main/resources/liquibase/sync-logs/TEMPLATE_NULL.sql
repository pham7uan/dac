...
BEGIN
  ...
  VALUES ('{{TABLE_NAME}}', Q, 'insert', NULL, IP_ADDRESS, UNIX_TIMESTAMP());
...
BEGIN
  ...
  INSERT INTO master_logs (`table_name`, `query_info`, `type`, `record_id`, `ip`, `created`)
  VALUES ('{{TABLE_NAME}}', Q, 'update', NULL, IP_ADDRESS, UNIX_TIMESTAMP());
...
BEGIN
  ...
  INSERT INTO master_logs (`table_name`, `query_info`, `type`, `record_id`, `ip`, `created`)
  VALUES ('{{TABLE_NAME}}', Q, 'delete', NULL, IP_ADDRESS, UNIX_TIMESTAMP());
